...
export class NewTableServiceWalletPayment1749098554652 implements MigrationInterface {
    name = 'NewTableServiceWalletPayment1749098554652'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`payments\` (\`id\` varchar(36) NOT NULL, \`payment_status\` varchar(255) ('Đang chờ', 'Thành công', 'Thất bại') NOT NULL, \`payment_date\` datetime NOT NULL, \`amount\` decimal NOT NULL, \`promotion\` decimal NULL, \`transaction_id\` varchar(255) NULL, \`payment_method\` varchar(255) ('vnpay', 'momo', 'zalopay') NULL, \`before_amount\` decimal NULL, \`after_amount\` decimal NULL, \`note\` varchar(255) NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`userId\` varchar(36) NULL, \`servicePriceId\` varchar(36) NULL, \`postId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
